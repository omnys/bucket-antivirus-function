...
yum update -y
#yum install -y cpio python27-pip zip yum-utils
...
echo "DNSDatabaseInfo current.cvd.clamav.net" > bin/freshclam.conf
echo "DatabaseMirror db.de.clamav.net" >> bin/freshclam.conf
echo "DatabaseMirror database.clamav.net" >> bin/freshclam.conf
echo "ConnectTimeout 30" >> bin/freshclam.conf
echo "ReceiveTimeout 30" >> bin/freshclam.conf
